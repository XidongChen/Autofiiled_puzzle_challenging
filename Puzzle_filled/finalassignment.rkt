...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname finalassignment) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
;;
;;******************************
;;   CS 135 Fall 2016
...
(neighbours-single (list (list #\a #\. #\.)
                         (list #\a #\. #\.)
                         (list #\a #\a #\a))
                   (list (list #\a #\.)
                         (list #\a #\a)))

(list (list #\a #\a #\.) (list #\a #\a #\a) (list #\a #\a #\a))


(define (neighbours my-state)
  (local [(define base (first my-state))
          (define lop (second my-state))]
